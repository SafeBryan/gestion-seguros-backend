    ...
    @Transactional
     class ContratoControllerIT {
        ...
        void setUp() {
            ...
            seguroVida.setMontoCobertura(new BigDecimal("10000.00")); // Campo específico de SeguroVida
            seguroVida.setActivo(true);
            seguroVida.setPrecioAnual(new BigDecimal("120.00"));
            seguroVida.setCreadoPor(cliente);
            seguroExistente = seguroRepository.save(seguroVida); // Guarda como 'seguroExistente'
        ...
        void crearContrato() throws Exception {
            ...
            dto.setBeneficiarios(java.util.List.of(beneficiario));
